...
for paragraph in paragraphs:
    ...
    for sentence in sentences:
        sent_tempo_variation = textinterpret.get_sent_tempo(sentence)
        ...
        for word in words:
            ...
            if len(word) >= 5:
                chord_notes = textinterpret.get_chord(scale, word, current_clock)
            ...
            while word_notes_length_sum > time_signature[0]:
                word_notes_length_sum = word_notes_length_sum - int(time_signature[0]/2)
